    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // *** BEGIN custom code to add custom fields to user db
                // *** Note for simplictity's sake we have ignore roles and company
                // *** We can set those later if we wish.
                ...
                if (result.Succeeded)
                {
                    ...
                    // *** BEGIN custom code to add custom fields to user db
                    // HERE is where we give the user a Role of CUSTOMER BY DEFAULT
                    // ADMIN can change it if neccessary
